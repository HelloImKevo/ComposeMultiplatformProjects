...
fun CurrencyCodePickerView(
    ...
    // The selected Currency Type will be vibrant (full saturation),
    // but all other un-selected options will have a grayscale effect.
...
@Preview
@Composable
private fun CurrencyCodePickerViewPreview() {
